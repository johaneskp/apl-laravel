    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $post->slug) }}" disable readonly >
                @error('slug')
                <div class="is-invalid">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="body" id="body" class="form-control @error('body') is-invalid   @enderror" cols="30" rows="7" value="{{ old('body', $post->body) }}">
                </textarea>
