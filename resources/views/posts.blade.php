    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <h3 class="card-title">
                        <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none text-dark"></a>{{ $posts[0]->title }}
                </h3>
        ...
        <div class="row">
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="posirion-absolute bg-dark px-3 py-2 text-white" style="background-color: rgba(0,0,0,0.7)">
                        ...
                        <div class="card-body">
                            <h5 class="card-decoration-none text-dark">
                                {{ $post->title }}
                            </h5>
                            <p>
                                <small class="text-muted">
